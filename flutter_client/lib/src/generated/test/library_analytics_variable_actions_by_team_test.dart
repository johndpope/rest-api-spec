...
// tests for LibraryAnalyticsVariableActionsByTeam
void main() {
  final instance = LibraryAnalyticsVariableActionsByTeamBuilder();
  // TODO add properties to the builder and call build()

  group(LibraryAnalyticsVariableActionsByTeam, () {
    ...
    // num detachments
    test('to test the property `detachments`', () async {
      // TODO
    });

    // The number of insertion events for this period.
    // num insertions
    test('to test the property `insertions`', () async {
      // TODO
    });
