...
// tests for SubcanvasNode
void main() {
  final instance = SubcanvasNodeBuilder();
  ...
  group(SubcanvasNode, () {
    ...
    test('to test the property `booleanOperation`', () async {
      // TODO
    });
    ...
    // ArcData arcData
    test('to test the property `arcData`', () async {
      // TODO
    });
    ...
    // BuiltList<Overrides> overrides
    test('to test the property `overrides`', () async {
      // TODO
    });

    // Whether the contents of the section are visible
    // bool sectionContentsHidden (default value: false)
    test('to test the property `sectionContentsHidden`', () async {
      // TODO
    });

    // ShapeType shapeType
    test('to test the property `shapeType`', () async {
      // TODO
    });
    ...
    test('to test the property `individualStrokeWeights`', () async {
      // TODO
    });

    // DevStatusTraitDevStatus devStatus
    test('to test the property `devStatus`', () async {
      // TODO
    });
    ...
    // BuiltMap<String, ComponentPropertyDefinition> componentPropertyDefinitions
    test('to test the property `componentPropertyDefinitions`', () async {
      // TODO
    });
    ...
    // bool isExposedInstance (default value: false)
    test('to test the property `isExposedInstance`', () async {
      // TODO
    });

    // IDs of instances that have been exposed to this node's level.
    // BuiltList<String> exposedInstances
    test('to test the property `exposedInstances`', () async {
      // TODO
    });
    ...
    // BuiltMap<String, ComponentProperty> componentProperties
    test('to test the property `componentProperties`', () async {
      // TODO
    });
