...
// tests for GetLibraryAnalyticsStyleActions200Response
void main() {
  final instance = GetLibraryAnalyticsStyleActions200ResponseBuilder();
  // TODO add properties to the builder and call build()

  group(GetLibraryAnalyticsStyleActions200Response, () {
    // GetLibraryAnalyticsStyleActions200ResponseRows rows
