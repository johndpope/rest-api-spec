...
// tests for PostCommentRequestClientMeta
void main() {
  final instance = PostCommentRequestClientMetaBuilder();
  // TODO add properties to the builder and call build()

  group(PostCommentRequestClientMeta, () {
    ...
    // Vector nodeOffset
    test('to test the property `nodeOffset`', () async {
      // TODO
    });
