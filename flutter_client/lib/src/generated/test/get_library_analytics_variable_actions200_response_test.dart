...
// tests for GetLibraryAnalyticsVariableActions200Response
void main() {
  final instance = GetLibraryAnalyticsVariableActions200ResponseBuilder();
  // TODO add properties to the builder and call build()

  group(GetLibraryAnalyticsVariableActions200Response, () {
    // GetLibraryAnalyticsVariableActions200ResponseRows rows
