...
// tests for GetLibraryAnalyticsVariableUsages200Response
void main() {
  final instance = GetLibraryAnalyticsVariableUsages200ResponseBuilder();
  // TODO add properties to the builder and call build()

  group(GetLibraryAnalyticsVariableUsages200Response, () {
    // GetLibraryAnalyticsVariableUsages200ResponseRows rows
