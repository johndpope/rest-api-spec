# figma_api.model.TextPathTypeStyle
...
**isOverrideOverTextStyle** | **bool** | Whether or not this style has overrides over a text style. The possible fields to override are semanticWeight, semanticItalic, and hyperlink. If this is true, then those fields are overrides if present. | [optional] 
**boundVariables** | [**TextPathTypeStyleAllOfBoundVariables**](TextPathTypeStyleAllOfBoundVariables.md) |  | [optional] 
