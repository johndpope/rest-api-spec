...
/// * [type] - The type of this node, represented by the string literal \"VECTOR\"
...
abstract class VectorNode
    implements CornerRadiusShapeTraits, Built<VectorNode, VectorNodeBuilder> {
  VectorNode._();

  factory VectorNode([void updates(VectorNodeBuilder b)]) = _$VectorNode;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(VectorNodeBuilder b) => b
    ..gridRowSpan = 1
    ..preserveRatio = false
  ...
  static Serializer<VectorNode> get serializer => _$VectorNodeSerializer();
}

class _$VectorNodeSerializer implements PrimitiveSerializer<VectorNode> {
  @override
  final Iterable<Type> types = const [VectorNode, _$VectorNode];

  @override
  final String wireName = r'VectorNode';
  ...
  void _deserializeProperties(
    ...
    required VectorNodeBuilder result,
  ...
  @override
  VectorNode deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = VectorNodeBuilder();
...
class VectorNodeTypeEnum extends EnumClass {
  /// The type of this node, represented by the string literal \"VECTOR\"
  @BuiltValueEnumConst(wireName: r'VECTOR')
  static const VectorNodeTypeEnum VECTOR = _$vectorNodeTypeEnum_VECTOR;

  static Serializer<VectorNodeTypeEnum> get serializer =>
      _$vectorNodeTypeEnumSerializer;

  const VectorNodeTypeEnum._(String name) : super(name);

  static BuiltSet<VectorNodeTypeEnum> get values => _$vectorNodeTypeEnumValues;
  static VectorNodeTypeEnum valueOf(String name) =>
      _$vectorNodeTypeEnumValueOf(name);
}

class VectorNodeScrollBehaviorEnum extends EnumClass {
  /// How layer should be treated when the frame is resized
  @BuiltValueEnumConst(wireName: r'SCROLLS')
  static const VectorNodeScrollBehaviorEnum SCROLLS =
      _$vectorNodeScrollBehaviorEnum_SCROLLS;

  /// How layer should be treated when the frame is resized
  @BuiltValueEnumConst(wireName: r'FIXED')
  static const VectorNodeScrollBehaviorEnum FIXED =
      _$vectorNodeScrollBehaviorEnum_FIXED;

  /// How layer should be treated when the frame is resized
  @BuiltValueEnumConst(wireName: r'STICKY_SCROLLS')
  static const VectorNodeScrollBehaviorEnum STICKY_SCROLLS =
      _$vectorNodeScrollBehaviorEnum_STICKY_SCROLLS;

  static Serializer<VectorNodeScrollBehaviorEnum> get serializer =>
      _$vectorNodeScrollBehaviorEnumSerializer;

  const VectorNodeScrollBehaviorEnum._(String name) : super(name);

  static BuiltSet<VectorNodeScrollBehaviorEnum> get values =>
      _$vectorNodeScrollBehaviorEnumValues;
  static VectorNodeScrollBehaviorEnum valueOf(String name) =>
      _$vectorNodeScrollBehaviorEnumValueOf(name);
}

class VectorNodeLayoutAlignEnum extends EnumClass {
  ...
  static const VectorNodeLayoutAlignEnum INHERIT =
      _$vectorNodeLayoutAlignEnum_INHERIT;

  ///  Determines if the layer should stretch along the parent's counter axis. This property is only provided for direct children of auto-layout frames.  - `INHERIT` - `STRETCH`  In previous versions of auto layout, determined how the layer is aligned inside an auto-layout frame. This property is only provided for direct children of auto-layout frames.  - `MIN` - `CENTER` - `MAX` - `STRETCH`  In horizontal auto-layout frames, \"MIN\" and \"MAX\" correspond to \"TOP\" and \"BOTTOM\". In vertical auto-layout frames, \"MIN\" and \"MAX\" correspond to \"LEFT\" and \"RIGHT\".
  @BuiltValueEnumConst(wireName: r'STRETCH')
  static const VectorNodeLayoutAlignEnum STRETCH =
      _$vectorNodeLayoutAlignEnum_STRETCH;

  ///  Determines if the layer should stretch along the parent's counter axis. This property is only provided for direct children of auto-layout frames.  - `INHERIT` - `STRETCH`  In previous versions of auto layout, determined how the layer is aligned inside an auto-layout frame. This property is only provided for direct children of auto-layout frames.  - `MIN` - `CENTER` - `MAX` - `STRETCH`  In horizontal auto-layout frames, \"MIN\" and \"MAX\" correspond to \"TOP\" and \"BOTTOM\". In vertical auto-layout frames, \"MIN\" and \"MAX\" correspond to \"LEFT\" and \"RIGHT\".
  @BuiltValueEnumConst(wireName: r'MIN')
  static const VectorNodeLayoutAlignEnum MIN = _$vectorNodeLayoutAlignEnum_MIN;

  ///  Determines if the layer should stretch along the parent's counter axis. This property is only provided for direct children of auto-layout frames.  - `INHERIT` - `STRETCH`  In previous versions of auto layout, determined how the layer is aligned inside an auto-layout frame. This property is only provided for direct children of auto-layout frames.  - `MIN` - `CENTER` - `MAX` - `STRETCH`  In horizontal auto-layout frames, \"MIN\" and \"MAX\" correspond to \"TOP\" and \"BOTTOM\". In vertical auto-layout frames, \"MIN\" and \"MAX\" correspond to \"LEFT\" and \"RIGHT\".
  @BuiltValueEnumConst(wireName: r'CENTER')
  static const VectorNodeLayoutAlignEnum CENTER =
      _$vectorNodeLayoutAlignEnum_CENTER;

  ///  Determines if the layer should stretch along the parent's counter axis. This property is only provided for direct children of auto-layout frames.  - `INHERIT` - `STRETCH`  In previous versions of auto layout, determined how the layer is aligned inside an auto-layout frame. This property is only provided for direct children of auto-layout frames.  - `MIN` - `CENTER` - `MAX` - `STRETCH`  In horizontal auto-layout frames, \"MIN\" and \"MAX\" correspond to \"TOP\" and \"BOTTOM\". In vertical auto-layout frames, \"MIN\" and \"MAX\" correspond to \"LEFT\" and \"RIGHT\".
  @BuiltValueEnumConst(wireName: r'MAX')
  static const VectorNodeLayoutAlignEnum MAX = _$vectorNodeLayoutAlignEnum_MAX;

  static Serializer<VectorNodeLayoutAlignEnum> get serializer =>
      _$vectorNodeLayoutAlignEnumSerializer;

  const VectorNodeLayoutAlignEnum._(String name) : super(name);

  static BuiltSet<VectorNodeLayoutAlignEnum> get values =>
      _$vectorNodeLayoutAlignEnumValues;
  static VectorNodeLayoutAlignEnum valueOf(String name) =>
      _$vectorNodeLayoutAlignEnumValueOf(name);
}

class VectorNodeLayoutGrowEnum extends EnumClass {
  /// This property is applicable only for direct children of auto-layout frames, ignored otherwise. Determines whether a layer should stretch along the parent's primary axis. A `0` corresponds to a fixed size and `1` corresponds to stretch.
  @BuiltValueEnumConst(wireName: r'0')
  static const VectorNodeLayoutGrowEnum n0 = _$vectorNodeLayoutGrowEnum_n0;

  /// This property is applicable only for direct children of auto-layout frames, ignored otherwise. Determines whether a layer should stretch along the parent's primary axis. A `0` corresponds to a fixed size and `1` corresponds to stretch.
  @BuiltValueEnumConst(wireName: r'1')
  static const VectorNodeLayoutGrowEnum n1 = _$vectorNodeLayoutGrowEnum_n1;

  static Serializer<VectorNodeLayoutGrowEnum> get serializer =>
      _$vectorNodeLayoutGrowEnumSerializer;

  const VectorNodeLayoutGrowEnum._(String name) : super(name);

  static BuiltSet<VectorNodeLayoutGrowEnum> get values =>
      _$vectorNodeLayoutGrowEnumValues;
  static VectorNodeLayoutGrowEnum valueOf(String name) =>
      _$vectorNodeLayoutGrowEnumValueOf(name);
}

class VectorNodeLayoutPositioningEnum extends EnumClass {
  /// Determines whether a layer's size and position should be determined by auto-layout settings or manually adjustable.
  @BuiltValueEnumConst(wireName: r'AUTO')
  static const VectorNodeLayoutPositioningEnum AUTO =
      _$vectorNodeLayoutPositioningEnum_AUTO;

  /// Determines whether a layer's size and position should be determined by auto-layout settings or manually adjustable.
  @BuiltValueEnumConst(wireName: r'ABSOLUTE')
  static const VectorNodeLayoutPositioningEnum ABSOLUTE =
      _$vectorNodeLayoutPositioningEnum_ABSOLUTE;

  static Serializer<VectorNodeLayoutPositioningEnum> get serializer =>
      _$vectorNodeLayoutPositioningEnumSerializer;

  const VectorNodeLayoutPositioningEnum._(String name) : super(name);

  static BuiltSet<VectorNodeLayoutPositioningEnum> get values =>
      _$vectorNodeLayoutPositioningEnumValues;
  static VectorNodeLayoutPositioningEnum valueOf(String name) =>
      _$vectorNodeLayoutPositioningEnumValueOf(name);
}

class VectorNodeLayoutSizingHorizontalEnum extends EnumClass {
  ...
  @BuiltValueEnumConst(wireName: r'FIXED')
  static const VectorNodeLayoutSizingHorizontalEnum FIXED =
      _$vectorNodeLayoutSizingHorizontalEnum_FIXED;

  /// The horizontal sizing setting on this auto-layout frame or frame child. - `FIXED` - `HUG`: only valid on auto-layout frames and text nodes - `FILL`: only valid on auto-layout frame children
  @BuiltValueEnumConst(wireName: r'HUG')
  static const VectorNodeLayoutSizingHorizontalEnum HUG =
      _$vectorNodeLayoutSizingHorizontalEnum_HUG;

  /// The horizontal sizing setting on this auto-layout frame or frame child. - `FIXED` - `HUG`: only valid on auto-layout frames and text nodes - `FILL`: only valid on auto-layout frame children
  @BuiltValueEnumConst(wireName: r'FILL')
  static const VectorNodeLayoutSizingHorizontalEnum FILL =
      _$vectorNodeLayoutSizingHorizontalEnum_FILL;

  static Serializer<VectorNodeLayoutSizingHorizontalEnum> get serializer =>
      _$vectorNodeLayoutSizingHorizontalEnumSerializer;

  const VectorNodeLayoutSizingHorizontalEnum._(String name) : super(name);

  static BuiltSet<VectorNodeLayoutSizingHorizontalEnum> get values =>
      _$vectorNodeLayoutSizingHorizontalEnumValues;
  static VectorNodeLayoutSizingHorizontalEnum valueOf(String name) =>
      _$vectorNodeLayoutSizingHorizontalEnumValueOf(name);
}

class VectorNodeLayoutSizingVerticalEnum extends EnumClass {
  ...
  @BuiltValueEnumConst(wireName: r'FIXED')
  static const VectorNodeLayoutSizingVerticalEnum FIXED =
      _$vectorNodeLayoutSizingVerticalEnum_FIXED;

  /// The vertical sizing setting on this auto-layout frame or frame child. - `FIXED` - `HUG`: only valid on auto-layout frames and text nodes - `FILL`: only valid on auto-layout frame children
  @BuiltValueEnumConst(wireName: r'HUG')
  static const VectorNodeLayoutSizingVerticalEnum HUG =
      _$vectorNodeLayoutSizingVerticalEnum_HUG;

  /// The vertical sizing setting on this auto-layout frame or frame child. - `FIXED` - `HUG`: only valid on auto-layout frames and text nodes - `FILL`: only valid on auto-layout frame children
  @BuiltValueEnumConst(wireName: r'FILL')
  static const VectorNodeLayoutSizingVerticalEnum FILL =
      _$vectorNodeLayoutSizingVerticalEnum_FILL;

  static Serializer<VectorNodeLayoutSizingVerticalEnum> get serializer =>
      _$vectorNodeLayoutSizingVerticalEnumSerializer;

  const VectorNodeLayoutSizingVerticalEnum._(String name) : super(name);

  static BuiltSet<VectorNodeLayoutSizingVerticalEnum> get values =>
      _$vectorNodeLayoutSizingVerticalEnumValues;
  static VectorNodeLayoutSizingVerticalEnum valueOf(String name) =>
      _$vectorNodeLayoutSizingVerticalEnumValueOf(name);
}

class VectorNodeGridChildHorizontalAlignEnum extends EnumClass {
  ...
  @BuiltValueEnumConst(wireName: r'AUTO')
  static const VectorNodeGridChildHorizontalAlignEnum AUTO =
      _$vectorNodeGridChildHorizontalAlignEnum_AUTO;

  /// Determines how a GRID frame's child should be aligned in the horizontal direction within its grid area. This property is only applicable for direct children of frames with `layoutMode: \"GRID\"`.
  @BuiltValueEnumConst(wireName: r'MIN')
  static const VectorNodeGridChildHorizontalAlignEnum MIN =
      _$vectorNodeGridChildHorizontalAlignEnum_MIN;

  /// Determines how a GRID frame's child should be aligned in the horizontal direction within its grid area. This property is only applicable for direct children of frames with `layoutMode: \"GRID\"`.
  @BuiltValueEnumConst(wireName: r'CENTER')
  static const VectorNodeGridChildHorizontalAlignEnum CENTER =
      _$vectorNodeGridChildHorizontalAlignEnum_CENTER;

  /// Determines how a GRID frame's child should be aligned in the horizontal direction within its grid area. This property is only applicable for direct children of frames with `layoutMode: \"GRID\"`.
  @BuiltValueEnumConst(wireName: r'MAX')
  static const VectorNodeGridChildHorizontalAlignEnum MAX =
      _$vectorNodeGridChildHorizontalAlignEnum_MAX;

  static Serializer<VectorNodeGridChildHorizontalAlignEnum> get serializer =>
      _$vectorNodeGridChildHorizontalAlignEnumSerializer;

  const VectorNodeGridChildHorizontalAlignEnum._(String name) : super(name);

  static BuiltSet<VectorNodeGridChildHorizontalAlignEnum> get values =>
      _$vectorNodeGridChildHorizontalAlignEnumValues;
  static VectorNodeGridChildHorizontalAlignEnum valueOf(String name) =>
      _$vectorNodeGridChildHorizontalAlignEnumValueOf(name);
}

class VectorNodeGridChildVerticalAlignEnum extends EnumClass {
  ...
  @BuiltValueEnumConst(wireName: r'AUTO')
  static const VectorNodeGridChildVerticalAlignEnum AUTO =
      _$vectorNodeGridChildVerticalAlignEnum_AUTO;

  /// Determines how a GRID frame's child should be aligned in the vertical direction within its grid area. This property is only applicable for direct children of frames with `layoutMode: \"GRID\"`.
  @BuiltValueEnumConst(wireName: r'MIN')
  static const VectorNodeGridChildVerticalAlignEnum MIN =
      _$vectorNodeGridChildVerticalAlignEnum_MIN;

  /// Determines how a GRID frame's child should be aligned in the vertical direction within its grid area. This property is only applicable for direct children of frames with `layoutMode: \"GRID\"`.
  @BuiltValueEnumConst(wireName: r'CENTER')
  static const VectorNodeGridChildVerticalAlignEnum CENTER =
      _$vectorNodeGridChildVerticalAlignEnum_CENTER;

  /// Determines how a GRID frame's child should be aligned in the vertical direction within its grid area. This property is only applicable for direct children of frames with `layoutMode: \"GRID\"`.
  @BuiltValueEnumConst(wireName: r'MAX')
  static const VectorNodeGridChildVerticalAlignEnum MAX =
      _$vectorNodeGridChildVerticalAlignEnum_MAX;

  static Serializer<VectorNodeGridChildVerticalAlignEnum> get serializer =>
      _$vectorNodeGridChildVerticalAlignEnumSerializer;

  const VectorNodeGridChildVerticalAlignEnum._(String name) : super(name);

  static BuiltSet<VectorNodeGridChildVerticalAlignEnum> get values =>
      _$vectorNodeGridChildVerticalAlignEnumValues;
  static VectorNodeGridChildVerticalAlignEnum valueOf(String name) =>
      _$vectorNodeGridChildVerticalAlignEnumValueOf(name);
}

class VectorNodeStrokeAlignEnum extends EnumClass {
  /// Position of stroke relative to vector outline, as a string enum  - `INSIDE`: stroke drawn inside the shape boundary - `OUTSIDE`: stroke drawn outside the shape boundary - `CENTER`: stroke drawn centered along the shape boundary
  @BuiltValueEnumConst(wireName: r'INSIDE')
  static const VectorNodeStrokeAlignEnum INSIDE =
      _$vectorNodeStrokeAlignEnum_INSIDE;

  /// Position of stroke relative to vector outline, as a string enum  - `INSIDE`: stroke drawn inside the shape boundary - `OUTSIDE`: stroke drawn outside the shape boundary - `CENTER`: stroke drawn centered along the shape boundary
  @BuiltValueEnumConst(wireName: r'OUTSIDE')
  static const VectorNodeStrokeAlignEnum OUTSIDE =
      _$vectorNodeStrokeAlignEnum_OUTSIDE;

  /// Position of stroke relative to vector outline, as a string enum  - `INSIDE`: stroke drawn inside the shape boundary - `OUTSIDE`: stroke drawn outside the shape boundary - `CENTER`: stroke drawn centered along the shape boundary
  @BuiltValueEnumConst(wireName: r'CENTER')
  static const VectorNodeStrokeAlignEnum CENTER =
      _$vectorNodeStrokeAlignEnum_CENTER;

  static Serializer<VectorNodeStrokeAlignEnum> get serializer =>
      _$vectorNodeStrokeAlignEnumSerializer;

  const VectorNodeStrokeAlignEnum._(String name) : super(name);

  static BuiltSet<VectorNodeStrokeAlignEnum> get values =>
      _$vectorNodeStrokeAlignEnumValues;
  static VectorNodeStrokeAlignEnum valueOf(String name) =>
      _$vectorNodeStrokeAlignEnumValueOf(name);
}

class VectorNodeStrokeJoinEnum extends EnumClass {
  /// A string enum with value of \"MITER\", \"BEVEL\", or \"ROUND\", describing how corners in vector paths are rendered.
  @BuiltValueEnumConst(wireName: r'MITER')
  static const VectorNodeStrokeJoinEnum MITER =
      _$vectorNodeStrokeJoinEnum_MITER;

  /// A string enum with value of \"MITER\", \"BEVEL\", or \"ROUND\", describing how corners in vector paths are rendered.
  @BuiltValueEnumConst(wireName: r'BEVEL')
  static const VectorNodeStrokeJoinEnum BEVEL =
      _$vectorNodeStrokeJoinEnum_BEVEL;

  /// A string enum with value of \"MITER\", \"BEVEL\", or \"ROUND\", describing how corners in vector paths are rendered.
  @BuiltValueEnumConst(wireName: r'ROUND')
  static const VectorNodeStrokeJoinEnum ROUND =
      _$vectorNodeStrokeJoinEnum_ROUND;

  static Serializer<VectorNodeStrokeJoinEnum> get serializer =>
      _$vectorNodeStrokeJoinEnumSerializer;

  const VectorNodeStrokeJoinEnum._(String name) : super(name);

  static BuiltSet<VectorNodeStrokeJoinEnum> get values =>
      _$vectorNodeStrokeJoinEnumValues;
  static VectorNodeStrokeJoinEnum valueOf(String name) =>
      _$vectorNodeStrokeJoinEnumValueOf(name);
}

class VectorNodeStrokeCapEnum extends EnumClass {
  /// A string enum describing the end caps of vector paths.
  @BuiltValueEnumConst(wireName: r'NONE')
  static const VectorNodeStrokeCapEnum NONE = _$vectorNodeStrokeCapEnum_NONE;

  /// A string enum describing the end caps of vector paths.
  @BuiltValueEnumConst(wireName: r'ROUND')
  static const VectorNodeStrokeCapEnum ROUND = _$vectorNodeStrokeCapEnum_ROUND;

  /// A string enum describing the end caps of vector paths.
  @BuiltValueEnumConst(wireName: r'SQUARE')
  static const VectorNodeStrokeCapEnum SQUARE =
      _$vectorNodeStrokeCapEnum_SQUARE;

  /// A string enum describing the end caps of vector paths.
  @BuiltValueEnumConst(wireName: r'LINE_ARROW')
  static const VectorNodeStrokeCapEnum LINE_ARROW =
      _$vectorNodeStrokeCapEnum_LINE_ARROW;

  /// A string enum describing the end caps of vector paths.
  @BuiltValueEnumConst(wireName: r'TRIANGLE_ARROW')
  static const VectorNodeStrokeCapEnum TRIANGLE_ARROW =
      _$vectorNodeStrokeCapEnum_TRIANGLE_ARROW;

  /// A string enum describing the end caps of vector paths.
  @BuiltValueEnumConst(wireName: r'DIAMOND_FILLED')
  static const VectorNodeStrokeCapEnum DIAMOND_FILLED =
      _$vectorNodeStrokeCapEnum_DIAMOND_FILLED;

  /// A string enum describing the end caps of vector paths.
  @BuiltValueEnumConst(wireName: r'CIRCLE_FILLED')
  static const VectorNodeStrokeCapEnum CIRCLE_FILLED =
      _$vectorNodeStrokeCapEnum_CIRCLE_FILLED;

  /// A string enum describing the end caps of vector paths.
  @BuiltValueEnumConst(wireName: r'TRIANGLE_FILLED')
  static const VectorNodeStrokeCapEnum TRIANGLE_FILLED =
      _$vectorNodeStrokeCapEnum_TRIANGLE_FILLED;

  /// A string enum describing the end caps of vector paths.
  @BuiltValueEnumConst(wireName: r'WASHI_TAPE_1')
  static const VectorNodeStrokeCapEnum wASHITAPE1 =
      _$vectorNodeStrokeCapEnum_wASHITAPE1;

  /// A string enum describing the end caps of vector paths.
  @BuiltValueEnumConst(wireName: r'WASHI_TAPE_2')
  static const VectorNodeStrokeCapEnum wASHITAPE2 =
      _$vectorNodeStrokeCapEnum_wASHITAPE2;

  /// A string enum describing the end caps of vector paths.
  @BuiltValueEnumConst(wireName: r'WASHI_TAPE_3')
  static const VectorNodeStrokeCapEnum wASHITAPE3 =
      _$vectorNodeStrokeCapEnum_wASHITAPE3;

  /// A string enum describing the end caps of vector paths.
  @BuiltValueEnumConst(wireName: r'WASHI_TAPE_4')
  static const VectorNodeStrokeCapEnum wASHITAPE4 =
      _$vectorNodeStrokeCapEnum_wASHITAPE4;

  /// A string enum describing the end caps of vector paths.
  @BuiltValueEnumConst(wireName: r'WASHI_TAPE_5')
  static const VectorNodeStrokeCapEnum wASHITAPE5 =
      _$vectorNodeStrokeCapEnum_wASHITAPE5;

  /// A string enum describing the end caps of vector paths.
  @BuiltValueEnumConst(wireName: r'WASHI_TAPE_6')
  static const VectorNodeStrokeCapEnum wASHITAPE6 =
      _$vectorNodeStrokeCapEnum_wASHITAPE6;

  static Serializer<VectorNodeStrokeCapEnum> get serializer =>
      _$vectorNodeStrokeCapEnumSerializer;

  const VectorNodeStrokeCapEnum._(String name) : super(name);

  static BuiltSet<VectorNodeStrokeCapEnum> get values =>
      _$vectorNodeStrokeCapEnumValues;
  static VectorNodeStrokeCapEnum valueOf(String name) =>
      _$vectorNodeStrokeCapEnumValueOf(name);
}

class VectorNodeMaskTypeEnum extends EnumClass {
  /// If this layer is a mask, this property describes the operation used to mask the layer's siblings. The value may be one of the following:  - ALPHA: the mask node's alpha channel will be used to determine the opacity of each pixel in the masked result. - VECTOR: if the mask node has visible fill paints, every pixel inside the node's fill regions will be fully visible in the masked result. If the mask has visible stroke paints, every pixel inside the node's stroke regions will be fully visible in the masked result. - LUMINANCE: the luminance value of each pixel of the mask node will be used to determine the opacity of that pixel in the masked result.
  @BuiltValueEnumConst(wireName: r'ALPHA')
  static const VectorNodeMaskTypeEnum ALPHA = _$vectorNodeMaskTypeEnum_ALPHA;

  /// If this layer is a mask, this property describes the operation used to mask the layer's siblings. The value may be one of the following:  - ALPHA: the mask node's alpha channel will be used to determine the opacity of each pixel in the masked result. - VECTOR: if the mask node has visible fill paints, every pixel inside the node's fill regions will be fully visible in the masked result. If the mask has visible stroke paints, every pixel inside the node's stroke regions will be fully visible in the masked result. - LUMINANCE: the luminance value of each pixel of the mask node will be used to determine the opacity of that pixel in the masked result.
  @BuiltValueEnumConst(wireName: r'VECTOR')
  static const VectorNodeMaskTypeEnum VECTOR = _$vectorNodeMaskTypeEnum_VECTOR;

  /// If this layer is a mask, this property describes the operation used to mask the layer's siblings. The value may be one of the following:  - ALPHA: the mask node's alpha channel will be used to determine the opacity of each pixel in the masked result. - VECTOR: if the mask node has visible fill paints, every pixel inside the node's fill regions will be fully visible in the masked result. If the mask has visible stroke paints, every pixel inside the node's stroke regions will be fully visible in the masked result. - LUMINANCE: the luminance value of each pixel of the mask node will be used to determine the opacity of that pixel in the masked result.
  @BuiltValueEnumConst(wireName: r'LUMINANCE')
  static const VectorNodeMaskTypeEnum LUMINANCE =
      _$vectorNodeMaskTypeEnum_LUMINANCE;

  static Serializer<VectorNodeMaskTypeEnum> get serializer =>
      _$vectorNodeMaskTypeEnumSerializer;

  const VectorNodeMaskTypeEnum._(String name) : super(name);

  static BuiltSet<VectorNodeMaskTypeEnum> get values =>
      _$vectorNodeMaskTypeEnumValues;
  static VectorNodeMaskTypeEnum valueOf(String name) =>
      _$vectorNodeMaskTypeEnumValueOf(name);
}
