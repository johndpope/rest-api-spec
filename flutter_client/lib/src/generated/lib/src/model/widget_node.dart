...
/// * [type] - The type of this node, represented by the string literal \"WIDGET\"
...
abstract class WidgetNode
    implements
        ...
        IsLayerTrait,
        Built<WidgetNode, WidgetNodeBuilder> {
  WidgetNode._();

  factory WidgetNode([void updates(WidgetNodeBuilder b)]) = _$WidgetNode;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(WidgetNodeBuilder b) => b
    ..visible = true
    ..rotation = 0
  ...
  static Serializer<WidgetNode> get serializer => _$WidgetNodeSerializer();
}

class _$WidgetNodeSerializer implements PrimitiveSerializer<WidgetNode> {
  @override
  final Iterable<Type> types = const [WidgetNode, _$WidgetNode];

  @override
  final String wireName = r'WidgetNode';
  ...
  void _deserializeProperties(
    ...
    required WidgetNodeBuilder result,
  ...
  @override
  WidgetNode deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = WidgetNodeBuilder();
...
class WidgetNodeTypeEnum extends EnumClass {
  /// The type of this node, represented by the string literal \"WIDGET\"
  @BuiltValueEnumConst(wireName: r'WIDGET')
  static const WidgetNodeTypeEnum WIDGET = _$widgetNodeTypeEnum_WIDGET;

  static Serializer<WidgetNodeTypeEnum> get serializer =>
      _$widgetNodeTypeEnumSerializer;

  const WidgetNodeTypeEnum._(String name) : super(name);

  static BuiltSet<WidgetNodeTypeEnum> get values => _$widgetNodeTypeEnumValues;
  static WidgetNodeTypeEnum valueOf(String name) =>
      _$widgetNodeTypeEnumValueOf(name);
}

class WidgetNodeScrollBehaviorEnum extends EnumClass {
  /// How layer should be treated when the frame is resized
  @BuiltValueEnumConst(wireName: r'SCROLLS')
  static const WidgetNodeScrollBehaviorEnum SCROLLS =
      _$widgetNodeScrollBehaviorEnum_SCROLLS;

  /// How layer should be treated when the frame is resized
  @BuiltValueEnumConst(wireName: r'FIXED')
  static const WidgetNodeScrollBehaviorEnum FIXED =
      _$widgetNodeScrollBehaviorEnum_FIXED;

  /// How layer should be treated when the frame is resized
  @BuiltValueEnumConst(wireName: r'STICKY_SCROLLS')
  static const WidgetNodeScrollBehaviorEnum STICKY_SCROLLS =
      _$widgetNodeScrollBehaviorEnum_STICKY_SCROLLS;

  static Serializer<WidgetNodeScrollBehaviorEnum> get serializer =>
      _$widgetNodeScrollBehaviorEnumSerializer;

  const WidgetNodeScrollBehaviorEnum._(String name) : super(name);

  static BuiltSet<WidgetNodeScrollBehaviorEnum> get values =>
      _$widgetNodeScrollBehaviorEnumValues;
  static WidgetNodeScrollBehaviorEnum valueOf(String name) =>
      _$widgetNodeScrollBehaviorEnumValueOf(name);
}
