...
part 'library_analytics_variable_actions_by_team.g.dart';
...
@BuiltValue()
abstract class LibraryAnalyticsVariableActionsByTeam
    implements
        Built<LibraryAnalyticsVariableActionsByTeam,
            LibraryAnalyticsVariableActionsByTeamBuilder> {
  ...
  LibraryAnalyticsVariableActionsByTeam._();

  factory LibraryAnalyticsVariableActionsByTeam(
          [void updates(LibraryAnalyticsVariableActionsByTeamBuilder b)]) =
      _$LibraryAnalyticsVariableActionsByTeam;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(LibraryAnalyticsVariableActionsByTeamBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<LibraryAnalyticsVariableActionsByTeam> get serializer =>
      _$LibraryAnalyticsVariableActionsByTeamSerializer();
}

class _$LibraryAnalyticsVariableActionsByTeamSerializer
    implements PrimitiveSerializer<LibraryAnalyticsVariableActionsByTeam> {
  @override
  ...
  @override
  final String wireName = r'LibraryAnalyticsVariableActionsByTeam';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    LibraryAnalyticsVariableActionsByTeam object, {
  ...
  void _deserializeProperties(
    ...
    required LibraryAnalyticsVariableActionsByTeamBuilder result,
  ...
  @override
  LibraryAnalyticsVariableActionsByTeam deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = LibraryAnalyticsVariableActionsByTeamBuilder();
