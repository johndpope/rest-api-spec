...
part 'default_shape_traits.g.dart';
...
abstract class DefaultShapeTraits
    implements
  ...
  static Serializer<DefaultShapeTraits> get serializer =>
      _$DefaultShapeTraitsSerializer();
}

class _$DefaultShapeTraitsSerializer
    implements PrimitiveSerializer<DefaultShapeTraits> {
  @override
  final Iterable<Type> types = const [DefaultShapeTraits];

  @override
  final String wireName = r'DefaultShapeTraits';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    DefaultShapeTraits object, {
  ...
  @override
  DefaultShapeTraits deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    return serializers.deserialize(serialized,
        specifiedType: FullType($DefaultShapeTraits)) as $DefaultShapeTraits;
  }
}

/// a concrete implementation of [DefaultShapeTraits], since [DefaultShapeTraits] is not instantiable
@BuiltValue(instantiable: true)
abstract class $DefaultShapeTraits
    implements
        DefaultShapeTraits,
        Built<$DefaultShapeTraits, $DefaultShapeTraitsBuilder> {
  $DefaultShapeTraits._();

  factory $DefaultShapeTraits(
          [void Function($DefaultShapeTraitsBuilder)? updates]) =
      _$$DefaultShapeTraits;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults($DefaultShapeTraitsBuilder b) => b;
...
class _$$DefaultShapeTraitsSerializer
  ...
  Object serialize(
    ...
    return serializers.serialize(object,
        specifiedType: FullType(DefaultShapeTraits))!;
  }
  ...
  void _deserializeProperties(
    ...
    required DefaultShapeTraitsBuilder result,
  ...
  $DefaultShapeTraits deserialize(
    ...
    final result = $DefaultShapeTraitsBuilder();
...
class DefaultShapeTraitsScrollBehaviorEnum extends EnumClass {
  /// How layer should be treated when the frame is resized
  @BuiltValueEnumConst(wireName: r'SCROLLS')
  static const DefaultShapeTraitsScrollBehaviorEnum SCROLLS =
      _$defaultShapeTraitsScrollBehaviorEnum_SCROLLS;

  /// How layer should be treated when the frame is resized
  @BuiltValueEnumConst(wireName: r'FIXED')
  static const DefaultShapeTraitsScrollBehaviorEnum FIXED =
      _$defaultShapeTraitsScrollBehaviorEnum_FIXED;

  /// How layer should be treated when the frame is resized
  @BuiltValueEnumConst(wireName: r'STICKY_SCROLLS')
  static const DefaultShapeTraitsScrollBehaviorEnum STICKY_SCROLLS =
      _$defaultShapeTraitsScrollBehaviorEnum_STICKY_SCROLLS;

  static Serializer<DefaultShapeTraitsScrollBehaviorEnum> get serializer =>
      _$defaultShapeTraitsScrollBehaviorEnumSerializer;

  const DefaultShapeTraitsScrollBehaviorEnum._(String name) : super(name);

  static BuiltSet<DefaultShapeTraitsScrollBehaviorEnum> get values =>
      _$defaultShapeTraitsScrollBehaviorEnumValues;
  static DefaultShapeTraitsScrollBehaviorEnum valueOf(String name) =>
      _$defaultShapeTraitsScrollBehaviorEnumValueOf(name);
}

class DefaultShapeTraitsLayoutAlignEnum extends EnumClass {
  ...
  static const DefaultShapeTraitsLayoutAlignEnum INHERIT =
      _$defaultShapeTraitsLayoutAlignEnum_INHERIT;

  ///  Determines if the layer should stretch along the parent's counter axis. This property is only provided for direct children of auto-layout frames.  - `INHERIT` - `STRETCH`  In previous versions of auto layout, determined how the layer is aligned inside an auto-layout frame. This property is only provided for direct children of auto-layout frames.  - `MIN` - `CENTER` - `MAX` - `STRETCH`  In horizontal auto-layout frames, \"MIN\" and \"MAX\" correspond to \"TOP\" and \"BOTTOM\". In vertical auto-layout frames, \"MIN\" and \"MAX\" correspond to \"LEFT\" and \"RIGHT\".
  @BuiltValueEnumConst(wireName: r'STRETCH')
  static const DefaultShapeTraitsLayoutAlignEnum STRETCH =
      _$defaultShapeTraitsLayoutAlignEnum_STRETCH;

  ///  Determines if the layer should stretch along the parent's counter axis. This property is only provided for direct children of auto-layout frames.  - `INHERIT` - `STRETCH`  In previous versions of auto layout, determined how the layer is aligned inside an auto-layout frame. This property is only provided for direct children of auto-layout frames.  - `MIN` - `CENTER` - `MAX` - `STRETCH`  In horizontal auto-layout frames, \"MIN\" and \"MAX\" correspond to \"TOP\" and \"BOTTOM\". In vertical auto-layout frames, \"MIN\" and \"MAX\" correspond to \"LEFT\" and \"RIGHT\".
  @BuiltValueEnumConst(wireName: r'MIN')
  static const DefaultShapeTraitsLayoutAlignEnum MIN =
      _$defaultShapeTraitsLayoutAlignEnum_MIN;

  ///  Determines if the layer should stretch along the parent's counter axis. This property is only provided for direct children of auto-layout frames.  - `INHERIT` - `STRETCH`  In previous versions of auto layout, determined how the layer is aligned inside an auto-layout frame. This property is only provided for direct children of auto-layout frames.  - `MIN` - `CENTER` - `MAX` - `STRETCH`  In horizontal auto-layout frames, \"MIN\" and \"MAX\" correspond to \"TOP\" and \"BOTTOM\". In vertical auto-layout frames, \"MIN\" and \"MAX\" correspond to \"LEFT\" and \"RIGHT\".
  @BuiltValueEnumConst(wireName: r'CENTER')
  static const DefaultShapeTraitsLayoutAlignEnum CENTER =
      _$defaultShapeTraitsLayoutAlignEnum_CENTER;

  ///  Determines if the layer should stretch along the parent's counter axis. This property is only provided for direct children of auto-layout frames.  - `INHERIT` - `STRETCH`  In previous versions of auto layout, determined how the layer is aligned inside an auto-layout frame. This property is only provided for direct children of auto-layout frames.  - `MIN` - `CENTER` - `MAX` - `STRETCH`  In horizontal auto-layout frames, \"MIN\" and \"MAX\" correspond to \"TOP\" and \"BOTTOM\". In vertical auto-layout frames, \"MIN\" and \"MAX\" correspond to \"LEFT\" and \"RIGHT\".
  @BuiltValueEnumConst(wireName: r'MAX')
  static const DefaultShapeTraitsLayoutAlignEnum MAX =
      _$defaultShapeTraitsLayoutAlignEnum_MAX;

  static Serializer<DefaultShapeTraitsLayoutAlignEnum> get serializer =>
      _$defaultShapeTraitsLayoutAlignEnumSerializer;

  const DefaultShapeTraitsLayoutAlignEnum._(String name) : super(name);

  static BuiltSet<DefaultShapeTraitsLayoutAlignEnum> get values =>
      _$defaultShapeTraitsLayoutAlignEnumValues;
  static DefaultShapeTraitsLayoutAlignEnum valueOf(String name) =>
      _$defaultShapeTraitsLayoutAlignEnumValueOf(name);
}

class DefaultShapeTraitsLayoutGrowEnum extends EnumClass {
  /// This property is applicable only for direct children of auto-layout frames, ignored otherwise. Determines whether a layer should stretch along the parent's primary axis. A `0` corresponds to a fixed size and `1` corresponds to stretch.
  @BuiltValueEnumConst(wireName: r'0')
  static const DefaultShapeTraitsLayoutGrowEnum n0 =
      _$defaultShapeTraitsLayoutGrowEnum_n0;

  /// This property is applicable only for direct children of auto-layout frames, ignored otherwise. Determines whether a layer should stretch along the parent's primary axis. A `0` corresponds to a fixed size and `1` corresponds to stretch.
  @BuiltValueEnumConst(wireName: r'1')
  static const DefaultShapeTraitsLayoutGrowEnum n1 =
      _$defaultShapeTraitsLayoutGrowEnum_n1;

  static Serializer<DefaultShapeTraitsLayoutGrowEnum> get serializer =>
      _$defaultShapeTraitsLayoutGrowEnumSerializer;

  const DefaultShapeTraitsLayoutGrowEnum._(String name) : super(name);

  static BuiltSet<DefaultShapeTraitsLayoutGrowEnum> get values =>
      _$defaultShapeTraitsLayoutGrowEnumValues;
  static DefaultShapeTraitsLayoutGrowEnum valueOf(String name) =>
      _$defaultShapeTraitsLayoutGrowEnumValueOf(name);
}

class DefaultShapeTraitsLayoutPositioningEnum extends EnumClass {
  /// Determines whether a layer's size and position should be determined by auto-layout settings or manually adjustable.
  @BuiltValueEnumConst(wireName: r'AUTO')
  static const DefaultShapeTraitsLayoutPositioningEnum AUTO =
      _$defaultShapeTraitsLayoutPositioningEnum_AUTO;

  /// Determines whether a layer's size and position should be determined by auto-layout settings or manually adjustable.
  @BuiltValueEnumConst(wireName: r'ABSOLUTE')
  static const DefaultShapeTraitsLayoutPositioningEnum ABSOLUTE =
      _$defaultShapeTraitsLayoutPositioningEnum_ABSOLUTE;

  static Serializer<DefaultShapeTraitsLayoutPositioningEnum> get serializer =>
      _$defaultShapeTraitsLayoutPositioningEnumSerializer;

  const DefaultShapeTraitsLayoutPositioningEnum._(String name) : super(name);

  static BuiltSet<DefaultShapeTraitsLayoutPositioningEnum> get values =>
      _$defaultShapeTraitsLayoutPositioningEnumValues;
  static DefaultShapeTraitsLayoutPositioningEnum valueOf(String name) =>
      _$defaultShapeTraitsLayoutPositioningEnumValueOf(name);
}

class DefaultShapeTraitsLayoutSizingHorizontalEnum extends EnumClass {
  ...
  @BuiltValueEnumConst(wireName: r'FIXED')
  static const DefaultShapeTraitsLayoutSizingHorizontalEnum FIXED =
      _$defaultShapeTraitsLayoutSizingHorizontalEnum_FIXED;

  /// The horizontal sizing setting on this auto-layout frame or frame child. - `FIXED` - `HUG`: only valid on auto-layout frames and text nodes - `FILL`: only valid on auto-layout frame children
  @BuiltValueEnumConst(wireName: r'HUG')
  static const DefaultShapeTraitsLayoutSizingHorizontalEnum HUG =
      _$defaultShapeTraitsLayoutSizingHorizontalEnum_HUG;

  /// The horizontal sizing setting on this auto-layout frame or frame child. - `FIXED` - `HUG`: only valid on auto-layout frames and text nodes - `FILL`: only valid on auto-layout frame children
  @BuiltValueEnumConst(wireName: r'FILL')
  static const DefaultShapeTraitsLayoutSizingHorizontalEnum FILL =
      _$defaultShapeTraitsLayoutSizingHorizontalEnum_FILL;

  static Serializer<DefaultShapeTraitsLayoutSizingHorizontalEnum>
      get serializer =>
          _$defaultShapeTraitsLayoutSizingHorizontalEnumSerializer;

  const DefaultShapeTraitsLayoutSizingHorizontalEnum._(String name)
      : super(name);

  static BuiltSet<DefaultShapeTraitsLayoutSizingHorizontalEnum> get values =>
      _$defaultShapeTraitsLayoutSizingHorizontalEnumValues;
  static DefaultShapeTraitsLayoutSizingHorizontalEnum valueOf(String name) =>
      _$defaultShapeTraitsLayoutSizingHorizontalEnumValueOf(name);
}

class DefaultShapeTraitsLayoutSizingVerticalEnum extends EnumClass {
  ...
  @BuiltValueEnumConst(wireName: r'FIXED')
  static const DefaultShapeTraitsLayoutSizingVerticalEnum FIXED =
      _$defaultShapeTraitsLayoutSizingVerticalEnum_FIXED;

  /// The vertical sizing setting on this auto-layout frame or frame child. - `FIXED` - `HUG`: only valid on auto-layout frames and text nodes - `FILL`: only valid on auto-layout frame children
  @BuiltValueEnumConst(wireName: r'HUG')
  static const DefaultShapeTraitsLayoutSizingVerticalEnum HUG =
      _$defaultShapeTraitsLayoutSizingVerticalEnum_HUG;

  /// The vertical sizing setting on this auto-layout frame or frame child. - `FIXED` - `HUG`: only valid on auto-layout frames and text nodes - `FILL`: only valid on auto-layout frame children
  @BuiltValueEnumConst(wireName: r'FILL')
  static const DefaultShapeTraitsLayoutSizingVerticalEnum FILL =
      _$defaultShapeTraitsLayoutSizingVerticalEnum_FILL;

  static Serializer<DefaultShapeTraitsLayoutSizingVerticalEnum>
      get serializer => _$defaultShapeTraitsLayoutSizingVerticalEnumSerializer;

  const DefaultShapeTraitsLayoutSizingVerticalEnum._(String name) : super(name);

  static BuiltSet<DefaultShapeTraitsLayoutSizingVerticalEnum> get values =>
      _$defaultShapeTraitsLayoutSizingVerticalEnumValues;
  static DefaultShapeTraitsLayoutSizingVerticalEnum valueOf(String name) =>
      _$defaultShapeTraitsLayoutSizingVerticalEnumValueOf(name);
}

class DefaultShapeTraitsGridChildHorizontalAlignEnum extends EnumClass {
  ...
  @BuiltValueEnumConst(wireName: r'AUTO')
  static const DefaultShapeTraitsGridChildHorizontalAlignEnum AUTO =
      _$defaultShapeTraitsGridChildHorizontalAlignEnum_AUTO;

  /// Determines how a GRID frame's child should be aligned in the horizontal direction within its grid area. This property is only applicable for direct children of frames with `layoutMode: \"GRID\"`.
  @BuiltValueEnumConst(wireName: r'MIN')
  static const DefaultShapeTraitsGridChildHorizontalAlignEnum MIN =
      _$defaultShapeTraitsGridChildHorizontalAlignEnum_MIN;

  /// Determines how a GRID frame's child should be aligned in the horizontal direction within its grid area. This property is only applicable for direct children of frames with `layoutMode: \"GRID\"`.
  @BuiltValueEnumConst(wireName: r'CENTER')
  static const DefaultShapeTraitsGridChildHorizontalAlignEnum CENTER =
      _$defaultShapeTraitsGridChildHorizontalAlignEnum_CENTER;

  /// Determines how a GRID frame's child should be aligned in the horizontal direction within its grid area. This property is only applicable for direct children of frames with `layoutMode: \"GRID\"`.
  @BuiltValueEnumConst(wireName: r'MAX')
  static const DefaultShapeTraitsGridChildHorizontalAlignEnum MAX =
      _$defaultShapeTraitsGridChildHorizontalAlignEnum_MAX;

  static Serializer<DefaultShapeTraitsGridChildHorizontalAlignEnum>
      get serializer =>
          _$defaultShapeTraitsGridChildHorizontalAlignEnumSerializer;

  const DefaultShapeTraitsGridChildHorizontalAlignEnum._(String name)
      : super(name);

  static BuiltSet<DefaultShapeTraitsGridChildHorizontalAlignEnum> get values =>
      _$defaultShapeTraitsGridChildHorizontalAlignEnumValues;
  static DefaultShapeTraitsGridChildHorizontalAlignEnum valueOf(String name) =>
      _$defaultShapeTraitsGridChildHorizontalAlignEnumValueOf(name);
}

class DefaultShapeTraitsGridChildVerticalAlignEnum extends EnumClass {
  ...
  @BuiltValueEnumConst(wireName: r'AUTO')
  static const DefaultShapeTraitsGridChildVerticalAlignEnum AUTO =
      _$defaultShapeTraitsGridChildVerticalAlignEnum_AUTO;

  /// Determines how a GRID frame's child should be aligned in the vertical direction within its grid area. This property is only applicable for direct children of frames with `layoutMode: \"GRID\"`.
  @BuiltValueEnumConst(wireName: r'MIN')
  static const DefaultShapeTraitsGridChildVerticalAlignEnum MIN =
      _$defaultShapeTraitsGridChildVerticalAlignEnum_MIN;

  /// Determines how a GRID frame's child should be aligned in the vertical direction within its grid area. This property is only applicable for direct children of frames with `layoutMode: \"GRID\"`.
  @BuiltValueEnumConst(wireName: r'CENTER')
  static const DefaultShapeTraitsGridChildVerticalAlignEnum CENTER =
      _$defaultShapeTraitsGridChildVerticalAlignEnum_CENTER;

  /// Determines how a GRID frame's child should be aligned in the vertical direction within its grid area. This property is only applicable for direct children of frames with `layoutMode: \"GRID\"`.
  @BuiltValueEnumConst(wireName: r'MAX')
  static const DefaultShapeTraitsGridChildVerticalAlignEnum MAX =
      _$defaultShapeTraitsGridChildVerticalAlignEnum_MAX;

  static Serializer<DefaultShapeTraitsGridChildVerticalAlignEnum>
      get serializer =>
          _$defaultShapeTraitsGridChildVerticalAlignEnumSerializer;

  const DefaultShapeTraitsGridChildVerticalAlignEnum._(String name)
      : super(name);

  static BuiltSet<DefaultShapeTraitsGridChildVerticalAlignEnum> get values =>
      _$defaultShapeTraitsGridChildVerticalAlignEnumValues;
  static DefaultShapeTraitsGridChildVerticalAlignEnum valueOf(String name) =>
      _$defaultShapeTraitsGridChildVerticalAlignEnumValueOf(name);
}

class DefaultShapeTraitsStrokeAlignEnum extends EnumClass {
  /// Position of stroke relative to vector outline, as a string enum  - `INSIDE`: stroke drawn inside the shape boundary - `OUTSIDE`: stroke drawn outside the shape boundary - `CENTER`: stroke drawn centered along the shape boundary
  @BuiltValueEnumConst(wireName: r'INSIDE')
  static const DefaultShapeTraitsStrokeAlignEnum INSIDE =
      _$defaultShapeTraitsStrokeAlignEnum_INSIDE;

  /// Position of stroke relative to vector outline, as a string enum  - `INSIDE`: stroke drawn inside the shape boundary - `OUTSIDE`: stroke drawn outside the shape boundary - `CENTER`: stroke drawn centered along the shape boundary
  @BuiltValueEnumConst(wireName: r'OUTSIDE')
  static const DefaultShapeTraitsStrokeAlignEnum OUTSIDE =
      _$defaultShapeTraitsStrokeAlignEnum_OUTSIDE;

  /// Position of stroke relative to vector outline, as a string enum  - `INSIDE`: stroke drawn inside the shape boundary - `OUTSIDE`: stroke drawn outside the shape boundary - `CENTER`: stroke drawn centered along the shape boundary
  @BuiltValueEnumConst(wireName: r'CENTER')
  static const DefaultShapeTraitsStrokeAlignEnum CENTER =
      _$defaultShapeTraitsStrokeAlignEnum_CENTER;

  static Serializer<DefaultShapeTraitsStrokeAlignEnum> get serializer =>
      _$defaultShapeTraitsStrokeAlignEnumSerializer;

  const DefaultShapeTraitsStrokeAlignEnum._(String name) : super(name);

  static BuiltSet<DefaultShapeTraitsStrokeAlignEnum> get values =>
      _$defaultShapeTraitsStrokeAlignEnumValues;
  static DefaultShapeTraitsStrokeAlignEnum valueOf(String name) =>
      _$defaultShapeTraitsStrokeAlignEnumValueOf(name);
}

class DefaultShapeTraitsStrokeJoinEnum extends EnumClass {
  /// A string enum with value of \"MITER\", \"BEVEL\", or \"ROUND\", describing how corners in vector paths are rendered.
  @BuiltValueEnumConst(wireName: r'MITER')
  static const DefaultShapeTraitsStrokeJoinEnum MITER =
      _$defaultShapeTraitsStrokeJoinEnum_MITER;

  /// A string enum with value of \"MITER\", \"BEVEL\", or \"ROUND\", describing how corners in vector paths are rendered.
  @BuiltValueEnumConst(wireName: r'BEVEL')
  static const DefaultShapeTraitsStrokeJoinEnum BEVEL =
      _$defaultShapeTraitsStrokeJoinEnum_BEVEL;

  /// A string enum with value of \"MITER\", \"BEVEL\", or \"ROUND\", describing how corners in vector paths are rendered.
  @BuiltValueEnumConst(wireName: r'ROUND')
  static const DefaultShapeTraitsStrokeJoinEnum ROUND =
      _$defaultShapeTraitsStrokeJoinEnum_ROUND;

  static Serializer<DefaultShapeTraitsStrokeJoinEnum> get serializer =>
      _$defaultShapeTraitsStrokeJoinEnumSerializer;

  const DefaultShapeTraitsStrokeJoinEnum._(String name) : super(name);

  static BuiltSet<DefaultShapeTraitsStrokeJoinEnum> get values =>
      _$defaultShapeTraitsStrokeJoinEnumValues;
  static DefaultShapeTraitsStrokeJoinEnum valueOf(String name) =>
      _$defaultShapeTraitsStrokeJoinEnumValueOf(name);
}

class DefaultShapeTraitsStrokeCapEnum extends EnumClass {
  /// A string enum describing the end caps of vector paths.
  @BuiltValueEnumConst(wireName: r'NONE')
  static const DefaultShapeTraitsStrokeCapEnum NONE =
      _$defaultShapeTraitsStrokeCapEnum_NONE;

  /// A string enum describing the end caps of vector paths.
  @BuiltValueEnumConst(wireName: r'ROUND')
  static const DefaultShapeTraitsStrokeCapEnum ROUND =
      _$defaultShapeTraitsStrokeCapEnum_ROUND;

  /// A string enum describing the end caps of vector paths.
  @BuiltValueEnumConst(wireName: r'SQUARE')
  static const DefaultShapeTraitsStrokeCapEnum SQUARE =
      _$defaultShapeTraitsStrokeCapEnum_SQUARE;

  /// A string enum describing the end caps of vector paths.
  @BuiltValueEnumConst(wireName: r'LINE_ARROW')
  static const DefaultShapeTraitsStrokeCapEnum LINE_ARROW =
      _$defaultShapeTraitsStrokeCapEnum_LINE_ARROW;

  /// A string enum describing the end caps of vector paths.
  @BuiltValueEnumConst(wireName: r'TRIANGLE_ARROW')
  static const DefaultShapeTraitsStrokeCapEnum TRIANGLE_ARROW =
      _$defaultShapeTraitsStrokeCapEnum_TRIANGLE_ARROW;

  /// A string enum describing the end caps of vector paths.
  @BuiltValueEnumConst(wireName: r'DIAMOND_FILLED')
  static const DefaultShapeTraitsStrokeCapEnum DIAMOND_FILLED =
      _$defaultShapeTraitsStrokeCapEnum_DIAMOND_FILLED;

  /// A string enum describing the end caps of vector paths.
  @BuiltValueEnumConst(wireName: r'CIRCLE_FILLED')
  static const DefaultShapeTraitsStrokeCapEnum CIRCLE_FILLED =
      _$defaultShapeTraitsStrokeCapEnum_CIRCLE_FILLED;

  /// A string enum describing the end caps of vector paths.
  @BuiltValueEnumConst(wireName: r'TRIANGLE_FILLED')
  static const DefaultShapeTraitsStrokeCapEnum TRIANGLE_FILLED =
      _$defaultShapeTraitsStrokeCapEnum_TRIANGLE_FILLED;

  /// A string enum describing the end caps of vector paths.
  @BuiltValueEnumConst(wireName: r'WASHI_TAPE_1')
  static const DefaultShapeTraitsStrokeCapEnum wASHITAPE1 =
      _$defaultShapeTraitsStrokeCapEnum_wASHITAPE1;

  /// A string enum describing the end caps of vector paths.
  @BuiltValueEnumConst(wireName: r'WASHI_TAPE_2')
  static const DefaultShapeTraitsStrokeCapEnum wASHITAPE2 =
      _$defaultShapeTraitsStrokeCapEnum_wASHITAPE2;

  /// A string enum describing the end caps of vector paths.
  @BuiltValueEnumConst(wireName: r'WASHI_TAPE_3')
  static const DefaultShapeTraitsStrokeCapEnum wASHITAPE3 =
      _$defaultShapeTraitsStrokeCapEnum_wASHITAPE3;

  /// A string enum describing the end caps of vector paths.
  @BuiltValueEnumConst(wireName: r'WASHI_TAPE_4')
  static const DefaultShapeTraitsStrokeCapEnum wASHITAPE4 =
      _$defaultShapeTraitsStrokeCapEnum_wASHITAPE4;

  /// A string enum describing the end caps of vector paths.
  @BuiltValueEnumConst(wireName: r'WASHI_TAPE_5')
  static const DefaultShapeTraitsStrokeCapEnum wASHITAPE5 =
      _$defaultShapeTraitsStrokeCapEnum_wASHITAPE5;

  /// A string enum describing the end caps of vector paths.
  @BuiltValueEnumConst(wireName: r'WASHI_TAPE_6')
  static const DefaultShapeTraitsStrokeCapEnum wASHITAPE6 =
      _$defaultShapeTraitsStrokeCapEnum_wASHITAPE6;

  static Serializer<DefaultShapeTraitsStrokeCapEnum> get serializer =>
      _$defaultShapeTraitsStrokeCapEnumSerializer;

  const DefaultShapeTraitsStrokeCapEnum._(String name) : super(name);

  static BuiltSet<DefaultShapeTraitsStrokeCapEnum> get values =>
      _$defaultShapeTraitsStrokeCapEnumValues;
  static DefaultShapeTraitsStrokeCapEnum valueOf(String name) =>
      _$defaultShapeTraitsStrokeCapEnumValueOf(name);
}

class DefaultShapeTraitsMaskTypeEnum extends EnumClass {
  /// If this layer is a mask, this property describes the operation used to mask the layer's siblings. The value may be one of the following:  - ALPHA: the mask node's alpha channel will be used to determine the opacity of each pixel in the masked result. - VECTOR: if the mask node has visible fill paints, every pixel inside the node's fill regions will be fully visible in the masked result. If the mask has visible stroke paints, every pixel inside the node's stroke regions will be fully visible in the masked result. - LUMINANCE: the luminance value of each pixel of the mask node will be used to determine the opacity of that pixel in the masked result.
  @BuiltValueEnumConst(wireName: r'ALPHA')
  static const DefaultShapeTraitsMaskTypeEnum ALPHA =
      _$defaultShapeTraitsMaskTypeEnum_ALPHA;

  /// If this layer is a mask, this property describes the operation used to mask the layer's siblings. The value may be one of the following:  - ALPHA: the mask node's alpha channel will be used to determine the opacity of each pixel in the masked result. - VECTOR: if the mask node has visible fill paints, every pixel inside the node's fill regions will be fully visible in the masked result. If the mask has visible stroke paints, every pixel inside the node's stroke regions will be fully visible in the masked result. - LUMINANCE: the luminance value of each pixel of the mask node will be used to determine the opacity of that pixel in the masked result.
  @BuiltValueEnumConst(wireName: r'VECTOR')
  static const DefaultShapeTraitsMaskTypeEnum VECTOR =
      _$defaultShapeTraitsMaskTypeEnum_VECTOR;

  /// If this layer is a mask, this property describes the operation used to mask the layer's siblings. The value may be one of the following:  - ALPHA: the mask node's alpha channel will be used to determine the opacity of each pixel in the masked result. - VECTOR: if the mask node has visible fill paints, every pixel inside the node's fill regions will be fully visible in the masked result. If the mask has visible stroke paints, every pixel inside the node's stroke regions will be fully visible in the masked result. - LUMINANCE: the luminance value of each pixel of the mask node will be used to determine the opacity of that pixel in the masked result.
  @BuiltValueEnumConst(wireName: r'LUMINANCE')
  static const DefaultShapeTraitsMaskTypeEnum LUMINANCE =
      _$defaultShapeTraitsMaskTypeEnum_LUMINANCE;

  static Serializer<DefaultShapeTraitsMaskTypeEnum> get serializer =>
      _$defaultShapeTraitsMaskTypeEnumSerializer;

  const DefaultShapeTraitsMaskTypeEnum._(String name) : super(name);

  static BuiltSet<DefaultShapeTraitsMaskTypeEnum> get values =>
      _$defaultShapeTraitsMaskTypeEnumValues;
  static DefaultShapeTraitsMaskTypeEnum valueOf(String name) =>
      _$defaultShapeTraitsMaskTypeEnumValueOf(name);
}
