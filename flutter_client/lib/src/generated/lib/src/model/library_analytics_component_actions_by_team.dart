...
part 'library_analytics_component_actions_by_team.g.dart';
...
@BuiltValue()
abstract class LibraryAnalyticsComponentActionsByTeam
    implements
        Built<LibraryAnalyticsComponentActionsByTeam,
            LibraryAnalyticsComponentActionsByTeamBuilder> {
  ...
  LibraryAnalyticsComponentActionsByTeam._();

  factory LibraryAnalyticsComponentActionsByTeam(
          [void updates(LibraryAnalyticsComponentActionsByTeamBuilder b)]) =
      _$LibraryAnalyticsComponentActionsByTeam;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(LibraryAnalyticsComponentActionsByTeamBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<LibraryAnalyticsComponentActionsByTeam> get serializer =>
      _$LibraryAnalyticsComponentActionsByTeamSerializer();
}

class _$LibraryAnalyticsComponentActionsByTeamSerializer
    implements PrimitiveSerializer<LibraryAnalyticsComponentActionsByTeam> {
  @override
  ...
  @override
  final String wireName = r'LibraryAnalyticsComponentActionsByTeam';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    LibraryAnalyticsComponentActionsByTeam object, {
  ...
  void _deserializeProperties(
    ...
    required LibraryAnalyticsComponentActionsByTeamBuilder result,
  ...
  @override
  LibraryAnalyticsComponentActionsByTeam deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = LibraryAnalyticsComponentActionsByTeamBuilder();
