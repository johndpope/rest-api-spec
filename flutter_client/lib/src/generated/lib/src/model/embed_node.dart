...
/// * [type] - The type of this node, represented by the string literal \"EMBED\"
...
@BuiltValue()
abstract class EmbedNode
    implements
        HasExportSettingsTrait,
        IsLayerTrait,
        Built<EmbedNode, EmbedNodeBuilder> {
  EmbedNode._();

  factory EmbedNode([void updates(EmbedNodeBuilder b)]) = _$EmbedNode;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(EmbedNodeBuilder b) => b
    ..visible = true
    ..rotation = 0
  ...
  static Serializer<EmbedNode> get serializer => _$EmbedNodeSerializer();
}

class _$EmbedNodeSerializer implements PrimitiveSerializer<EmbedNode> {
  @override
  final Iterable<Type> types = const [EmbedNode, _$EmbedNode];

  @override
  final String wireName = r'EmbedNode';
  ...
  void _deserializeProperties(
    ...
    required EmbedNodeBuilder result,
  ...
  @override
  EmbedNode deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = EmbedNodeBuilder();
...
class EmbedNodeTypeEnum extends EnumClass {
  /// The type of this node, represented by the string literal \"EMBED\"
  @BuiltValueEnumConst(wireName: r'EMBED')
  static const EmbedNodeTypeEnum EMBED = _$embedNodeTypeEnum_EMBED;

  static Serializer<EmbedNodeTypeEnum> get serializer =>
      _$embedNodeTypeEnumSerializer;

  const EmbedNodeTypeEnum._(String name) : super(name);

  static BuiltSet<EmbedNodeTypeEnum> get values => _$embedNodeTypeEnumValues;
  static EmbedNodeTypeEnum valueOf(String name) =>
      _$embedNodeTypeEnumValueOf(name);
}

class EmbedNodeScrollBehaviorEnum extends EnumClass {
  /// How layer should be treated when the frame is resized
  @BuiltValueEnumConst(wireName: r'SCROLLS')
  static const EmbedNodeScrollBehaviorEnum SCROLLS =
      _$embedNodeScrollBehaviorEnum_SCROLLS;

  /// How layer should be treated when the frame is resized
  @BuiltValueEnumConst(wireName: r'FIXED')
  static const EmbedNodeScrollBehaviorEnum FIXED =
      _$embedNodeScrollBehaviorEnum_FIXED;

  /// How layer should be treated when the frame is resized
  @BuiltValueEnumConst(wireName: r'STICKY_SCROLLS')
  static const EmbedNodeScrollBehaviorEnum STICKY_SCROLLS =
      _$embedNodeScrollBehaviorEnum_STICKY_SCROLLS;

  static Serializer<EmbedNodeScrollBehaviorEnum> get serializer =>
      _$embedNodeScrollBehaviorEnumSerializer;

  const EmbedNodeScrollBehaviorEnum._(String name) : super(name);

  static BuiltSet<EmbedNodeScrollBehaviorEnum> get values =>
      _$embedNodeScrollBehaviorEnumValues;
  static EmbedNodeScrollBehaviorEnum valueOf(String name) =>
      _$embedNodeScrollBehaviorEnumValueOf(name);
}
