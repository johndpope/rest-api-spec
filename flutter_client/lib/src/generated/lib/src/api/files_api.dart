...
import 'package:figma_api/src/model/get_file_meta200_response.dart';
import 'package:figma_api/src/model/get_file_nodes200_response.dart';
import 'package:figma_api/src/model/get_file_versions200_response.dart';
import 'package:figma_api/src/model/get_image_fills200_response.dart';
...
class FilesApi {
  ...
  /// * [pluginData] - A comma separated list of plugin IDs and/or the string \"shared\". Any data present in the document written by those plugins will be included in the result in the `pluginData` and `sharedPluginData` properties.
  /// * [branchData] - Returns branch metadata for the requested file. If the file is a branch, the main file's key will be included in the returned response. If the file has branches, their metadata will be included in the returned response. Default: false.
  ...
  Future<Response<GetFile200Response>> getFile({
    ...
    final _path = r'/v1/files/{file_key}'.replaceAll(
        '{' r'file_key' '}',
    ...
    final _queryParameters = <String, dynamic>{
      ...
      if (depth != null)
        r'depth':
            encodeQueryParameter(_serializers, depth, const FullType(num)),
      if (geometry != null)
        r'geometry': encodeQueryParameter(
            _serializers, geometry, const FullType(String)),
      if (pluginData != null)
        r'plugin_data': encodeQueryParameter(
            _serializers, pluginData, const FullType(String)),
      if (branchData != null)
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(GetFile200Response),
            ) as GetFile200Response;
  ...
  ///
  /// Parameters:
  /// * [fileKey] - File to get metadata for. This can be a file key or branch key. Use `GET /v1/files/:key` with the `branch_data` query param to get the branch key.
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [GetFileMeta200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetFileMeta200Response>> getFileMeta({
    required String fileKey,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/v1/files/{file_key}/meta'.replaceAll(
        '{' r'file_key' '}',
        encodeQueryParameter(_serializers, fileKey, const FullType(String))
            .toString());
    final _options = Options(
    ...
    GetFileMeta200Response? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(GetFileMeta200Response),
            ) as GetFileMeta200Response;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<GetFileMeta200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [version] - A specific version ID to get. Omitting this will get the current version of the file.
  /// * [depth] - Positive integer representing how deep into the node tree to traverse. For example, setting this to 1 will return only the children directly underneath the desired nodes. Not setting this parameter returns all nodes.  Note: this parameter behaves differently from the same parameter in the `GET /v1/files/:key` endpoint. In this endpoint, the depth will be counted starting from the desired node rather than the document root node.
  /// * [geometry] - Set to \"paths\" to export vector data.
  /// * [pluginData] - A comma separated list of plugin IDs and/or the string \"shared\". Any data present in the document written by those plugins will be included in the result in the `pluginData` and `sharedPluginData` properties.
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [GetFileNodes200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetFileNodes200Response>> getFileNodes({
    required String fileKey,
    required String ids,
    String? version,
    num? depth,
    ...
    final _path = r'/v1/files/{file_key}/nodes'.replaceAll(
        '{' r'file_key' '}',
        encodeQueryParameter(_serializers, fileKey, const FullType(String))
            .toString());
    final _options = Options(
    ...
    GetFileNodes200Response? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(GetFileNodes200Response),
            ) as GetFileNodes200Response;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<GetFileNodes200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  ///
  /// Parameters:
  /// * [fileKey] - File to get version history from. This can be a file key or branch key. Use `GET /v1/files/:key` with the `branch_data` query param to get the branch key.
  /// * [pageSize] - The number of items returned in a page of the response. If not included, `page_size` is `30`.
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [GetFileVersions200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetFileVersions200Response>> getFileVersions({
    required String fileKey,
    num? pageSize,
    num? before,
    num? after,
    ...
    final _path = r'/v1/files/{file_key}/versions'.replaceAll(
        '{' r'file_key' '}',
        encodeQueryParameter(_serializers, fileKey, const FullType(String))
            .toString());
    final _options = Options(
    ...
    GetFileVersions200Response? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(GetFileVersions200Response),
            ) as GetFileVersions200Response;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<GetFileVersions200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  ///
  /// Parameters:
  /// * [fileKey] - File to get image URLs from. This can be a file key or branch key. Use `GET /v1/files/:key` with the `branch_data` query param to get the branch key.
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [GetImageFills200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetImageFills200Response>> getImageFills({
    required String fileKey,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/v1/files/{file_key}/images'.replaceAll(
        '{' r'file_key' '}',
        encodeQueryParameter(_serializers, fileKey, const FullType(String))
            .toString());
    final _options = Options(
    ...
    GetImageFills200Response? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(GetImageFills200Response),
            ) as GetImageFills200Response;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<GetImageFills200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  ///
  /// Parameters:
  /// * [fileKey] - File to export images from. This can be a file key or branch key. Use `GET /v1/files/:key` with the `branch_data` query param to get the branch key.
  ...
  /// * [svgOutlineText] - Whether text elements are rendered as outlines (vector paths) or as `<text>` elements in SVGs.  Rendering text elements as outlines guarantees that the text looks exactly the same in the SVG as it does in the browser/inside Figma.  Exporting as `<text>` allows text to be selectable inside SVGs and generally makes the SVG easier to read. However, this relies on the browser's rendering engine which can vary between browsers and/or operating systems. As such, visual accuracy is not guaranteed as the result could look different than in Figma.
  /// * [svgIncludeId] - Whether to include id attributes for all SVG elements. Adds the layer name to the `id` attribute of an svg element.
  /// * [svgIncludeNodeId] - Whether to include node id attributes for all SVG elements. Adds the node id to a `data-node-id` attribute of an svg element.
  /// * [svgSimplifyStroke] - Whether to simplify inside/outside strokes and use stroke attribute if possible instead of `<mask>`.
  /// * [contentsOnly] - Whether content that overlaps the node should be excluded from rendering. Passing false (i.e., rendering overlaps) may increase processing time, since more of the document must be included in rendering.
  /// * [useAbsoluteBounds] - Use the full dimensions of the node regardless of whether or not it is cropped or the space around it is empty. Use this to export text nodes without cropping.
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  Future<Response<GetImages200Response>> getImages({
    ...
    bool? svgIncludeId = false,
    bool? svgIncludeNodeId = false,
    ...
    final _path = r'/v1/images/{file_key}'.replaceAll(
        '{' r'file_key' '}',
        encodeQueryParameter(_serializers, fileKey, const FullType(String))
            .toString());
    final _options = Options(
    ...
    final _queryParameters = <String, dynamic>{
      ...
      if (svgOutlineText != null)
        r'svg_outline_text': encodeQueryParameter(
            _serializers, svgOutlineText, const FullType(bool)),
      if (svgIncludeId != null)
        r'svg_include_id': encodeQueryParameter(
            _serializers, svgIncludeId, const FullType(bool)),
      if (svgIncludeNodeId != null)
        r'svg_include_node_id': encodeQueryParameter(
            _serializers, svgIncludeNodeId, const FullType(bool)),
      if (svgSimplifyStroke != null)
        r'svg_simplify_stroke': encodeQueryParameter(
            _serializers, svgSimplifyStroke, const FullType(bool)),
      if (contentsOnly != null)
        r'contents_only': encodeQueryParameter(
            _serializers, contentsOnly, const FullType(bool)),
      if (useAbsoluteBounds != null)
        r'use_absolute_bounds': encodeQueryParameter(
            _serializers, useAbsoluteBounds, const FullType(bool)),
    };
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(GetImages200Response),
            ) as GetImages200Response;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
