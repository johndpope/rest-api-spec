...
**background_color** | [**models::Rgba**](RGBA.md) |  | 
**prototype_start_node_id** | Option<[**serde_json::Value**](.md)> | Node ID that corresponds to the start frame for prototypes. This is deprecated with the introduction of multiple flows. Please use the `flowStartingPoints` field. | 
...
**prototype_device** | [**models::PrototypeDevice**](PrototypeDevice.md) |  | 
