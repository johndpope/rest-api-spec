...
**plugin_data** | Option<[**serde_json::Value**](.md)> | Data written by plugins that is visible only to the plugin that wrote it. Requires the `pluginData` to include the ID of the plugin. | [optional]
**shared_plugin_data** | Option<[**serde_json::Value**](.md)> | Data written by plugins that is visible to all plugins. Requires the `pluginData` parameter to include the string \"shared\". | [optional]
...
**blend_mode** | [**models::BlendMode**](BlendMode.md) |  | 
...
**connector_start** | [**models::ConnectorEndpoint**](ConnectorEndpoint.md) |  | 
**connector_end** | [**models::ConnectorEndpoint**](ConnectorEndpoint.md) |  | 
...
**connector_line_type** | [**models::ConnectorLineType**](ConnectorLineType.md) |  | 
**text_background** | Option<[**models::ConnectorTextBackground**](ConnectorTextBackground.md)> |  | [optional]
