...
**background_color** | Option<[**models::Rgba**](RGBA.md)> |  | [optional]
...
**transition_easing** | Option<[**models::EasingType**](EasingType.md)> |  | [optional]
**interactions** | Option<[**Vec<models::Interaction>**](Interaction.md)> |  | [optional]
**individual_stroke_weights** | Option<[**models::StrokeWeights**](StrokeWeights.md)> |  | [optional]
