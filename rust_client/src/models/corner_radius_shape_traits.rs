...
impl CornerRadiusShapeTraits {
    pub fn new(id: String, name: String, r#type: String, scroll_behavior: ScrollBehavior, blend_mode: models::BlendMode, absolute_bounding_box: models::Rectangle, absolute_render_bounds: models::Rectangle, fills: Vec<models::Paint>, effects: Vec<models::Effect>) -> CornerRadiusShapeTraits {
