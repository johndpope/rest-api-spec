...
pub struct Comment {
    ...
    pub resolved_at: Option<Option<serde_json::Value>>,
...
impl Comment {
    ...
    pub fn new(id: String, client_meta: models::CommentClientMeta, file_key: String, user: models::User, created_at: String, message: String, order_id: Option<serde_json::Value>, reactions: Vec<models::Reaction>) -> Comment {
        Comment {
            id,
