...
impl BooleanOperationNode {
    pub fn new(id: String, name: String, r#type: Type, scroll_behavior: ScrollBehavior, blend_mode: models::BlendMode, children: Vec<models::SubcanvasNode>, absolute_bounding_box: models::Rectangle, absolute_render_bounds: models::Rectangle, fills: Vec<models::Paint>, effects: Vec<models::Effect>, boolean_operation: BooleanOperation) -> BooleanOperationNode {
