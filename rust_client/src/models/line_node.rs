...
impl LineNode {
    pub fn new(id: String, name: String, r#type: Type, scroll_behavior: ScrollBehavior, blend_mode: models::BlendMode, absolute_bounding_box: models::Rectangle, absolute_render_bounds: models::Rectangle, fills: Vec<models::Paint>, effects: Vec<models::Effect>) -> LineNode {
        LineNode {
            id,
            name,
            r#type,
