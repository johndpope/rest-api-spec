...
pub struct GetFileNodes200Response {
    ...
    #[serde(rename = "nodes")]
    pub nodes: std::collections::HashMap<String, models::GetFileNodes200ResponseNodesValue>,
}

impl GetFileNodes200Response {
    pub fn new(name: String, role: models::Role, last_modified: String, editor_type: EditorType, thumbnail_url: String, version: String, nodes: std::collections::HashMap<String, models::GetFileNodes200ResponseNodesValue>) -> GetFileNodes200Response {
