...
impl MultitoneNoiseEffect {
    pub fn new(r#type: Type, color: models::Rgba, visible: bool, blend_mode: models::BlendMode, noise_size: f64, density: f64, noise_type: NoiseType, opacity: f64) -> MultitoneNoiseEffect {
