...
pub struct NodeAction {
    ...
    pub destination_id: Option<serde_json::Value>,
...
impl NodeAction {
    ...
    pub fn new(r#type: Type, destination_id: Option<serde_json::Value>, navigation: models::Navigation, transition: Option<models::Transition>) -> NodeAction {
        NodeAction {
            r#type,
            destination_id,
            navigation,
