...
pub struct BaseTypeStyle {
    ...
    #[serde(rename = "fontPostScriptName", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub font_post_script_name: Option<Option<serde_json::Value>>,
