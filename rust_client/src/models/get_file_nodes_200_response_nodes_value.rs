...
pub struct GetFileNodes200ResponseNodesValue {
...
impl GetFileNodes200ResponseNodesValue {
    pub fn new(document: models::Node, components: std::collections::HashMap<String, models::Component>, component_sets: std::collections::HashMap<String, models::ComponentSet>, schema_version: f64, styles: std::collections::HashMap<String, models::Style>) -> GetFileNodes200ResponseNodesValue {
