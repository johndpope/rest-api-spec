...
pub struct GetPublishedVariables200ResponseMeta {
...
impl GetPublishedVariables200ResponseMeta {
    pub fn new(variables: std::collections::HashMap<String, models::PublishedVariable>, variable_collections: std::collections::HashMap<String, models::PublishedVariableCollection>) -> GetPublishedVariables200ResponseMeta {
