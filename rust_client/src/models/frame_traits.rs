...
impl FrameTraits {
    pub fn new(id: String, name: String, r#type: String, scroll_behavior: ScrollBehavior, blend_mode: models::BlendMode, children: Vec<models::SubcanvasNode>, absolute_bounding_box: models::Rectangle, absolute_render_bounds: models::Rectangle, clips_content: bool, fills: Vec<models::Paint>, effects: Vec<models::Effect>) -> FrameTraits {
        FrameTraits {
            id,
            name,
            r#type,
