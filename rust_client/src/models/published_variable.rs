...
impl PublishedVariable {
    ...
    pub fn new(id: String, subscribed_id: String, name: String, key: String, variable_collection_id: String, resolved_data_type: models::VariableResolvedDataType, updated_at: String) -> PublishedVariable {
        PublishedVariable {
            id,
            subscribed_id,
            name,
